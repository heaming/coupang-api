...
import { ProductsService } from './quickstar/products.service';
import { ProductsController } from './quickstar/products.controller';
...
@Module({
  ...
  controllers: [AppController, CoupangApiController, ProductsController],
  providers: [AppService, CoupangApiService, ProductsService],
})
